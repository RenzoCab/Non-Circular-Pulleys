...
tested_pulley = "Triangle";
filename_40   = "40_tri_zyx";
filename_80   = "80_tri_zyx";
filename_120  = "120_tri_zyx";
...
vector_time   = t_40(11120:24553);
vector_time_1 = vector_time(1101:4718);
vector_time_2 = vector_time(5141:8776);
delta_t       = vector_time_1(500) - vector_time_1(499);

vector_xn   = X_n_40(11120:24553);
vector_xn_1 = vector_xn(1101:4718);
vector_xn_2 = vector_xn(5141:8776);

vector_xp   = X_p_40(11120:24553);
vector_xp_1 = vector_xp(1101:4718);
vector_xp_2 = vector_xp(5141:8776);

vector_yn   = Y_n_40(11120:24553);
vector_yn_1 = vector_yn(1101:4718);
vector_yn_2 = vector_yn(5141:8776);

vector_pn   = Y_p_40(11120:24553);
vector_pn_1 = vector_pn(1101:4718);
vector_pn_2 = vector_pn(5141:8776);

vector_rot_y   = ry_40(11120:24553);
vector_rot_y_1 = vector_rot_y(1101:4718); % Anticlockwise
vector_rot_y_2 = vector_rot_y(5141:8776); % Clockwise
...
nexttile
plot(d_nozzle_pulley_40(52424:60517),'b--');
title(strcat('Displacement at speed 40 - ', tested_pulley)); 
xlabel('Time'); 
ylabel('d (mm)');

nexttile
plot(ry_40(52424:60517),'b*-');
title('Rotaion (Yaw)'); 
xlabel('Time'); 
ylabel('degrees');

nexttile
plot(dudt_40(52424:60517));
...
nexttile
plot(d_nozzle_pulley_80(57189:62846),'b--');
title(strcat('Displacement at speed 80 - ', tested_pulley)); 
xlabel('Time'); 
ylabel('d (mm)');

nexttile
plot(ry_80(57189:62846),'b*-');
title('Rotaion (Yaw)'); 
xlabel('Time'); 
ylabel('degrees');

nexttile
plot(dudt_80(57189:62846));
...
nexttile
plot(d_nozzle_pulley_120(57241:61246),'b--');
title(strcat('Displacement at speed 120 - ', tested_pulley)); 
xlabel('Time'); 
ylabel('d (mm)');

nexttile
plot(ry_120(57241:61246),'b*-');
title('Rotaion (Yaw)'); 
xlabel('Time'); 
ylabel('degrees');

nexttile
plot(dudt_120(57241:61246));
...
tiledlayout(2,1);
nexttile
plot(d_nozzle_pulley_40(52224:56318),'b--');
title(strcat('Displacement at speed 40 - ', tested_pulley)); 
xlabel('Time'); 
ylabel('d (mm)');
...
tiledlayout(2,1);
nexttile
plot(d_nozzle_pulley_80(57246:60030),'b--');
title(strcat('Displacement at speed 80 - ', tested_pulley)); 
xlabel('Time'); 
ylabel('d (mm)');
...
smoothedData2 = smoothdata(dudt_80_zoom,...
    'lowess','SmoothingFactor',0.9399999999999999);
...
tiledlayout(2,1);
nexttile
plot(d_nozzle_pulley_120(57190:59251),'b--');
title(strcat('Displacement at speed 120 - ', tested_pulley)); 
xlabel('Time'); 
ylabel('d (mm)');
% Smooth input data
smoothedData3 = smoothdata(dudt_120_zoom,...
    'lowess','SmoothingFactor',0.9499999999999999);
...
% Save derivatives
save("C:\Users\preciaac\Documents\PhD\SelfRepairing_Research\Tracking_experiment\SmoothPlot_tri_allspeeds\dudt_tri_40.mat", "dudt_40");
save("C:\Users\preciaac\Documents\PhD\SelfRepairing_Research\Tracking_experiment\SmoothPlot_tri_allspeeds\dudt_tri_80.mat", "dudt_80");
save("C:\Users\preciaac\Documents\PhD\SelfRepairing_Research\Tracking_experiment\SmoothPlot_tri_allspeeds\dudt_tri_120.mat", "dudt_120");
